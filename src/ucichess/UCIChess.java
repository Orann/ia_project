 ...
 * *******************
 * UCIChess API<br>
 * This API help you to communicate with Chess Engine that respect Universal
 * Chess Interface protocol communication.<br>
 * You can with this API, run a chess engine, send him some uci commands and
 * read responses from this engine.<br>
 *
 ...
 * );<br>
 * }<br>
 * System.out.println("=====================PLAY A SMALL
 * GAME=====================");<br>
 *           //is engine ready?<br>
...
public class UCIChess {
     ...
     * Start the chess engine in a ProcessBuilder and connect in and out streams
     * communications with this process.<br>
     *
     ...
     * FEN format example : rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq -
     * 0 1<br>
...
//========================ENGINE STATES==============================
     ...
     * String getValues(); retrieve the default and possibles values for this
     * option<br>
     * <br>
